...
public:
	...
	// Reserves a new slot of memory if more memory is requested. Data is moved or copied
	...
	template<typename U>
	void push_back(const U& elem)
	{
    static_assert(std::is_same<T, U>::value, 
        "push_back argument type must exactly match Vector type");
